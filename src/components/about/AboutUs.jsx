     ...
     isolate sm:py-32`}>
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          `}>
            אתר וורטלי שם לעצמו למטרה להוות פלטפורמה נוחה ויעילה לפרסום חידושי תורה עצמיים.  האתר מתוכנן ונבנה בצורה נוחה ואינטואטיבית בדגש על חווית משתמש, על מנת לאפשר לך להפיץ את חידושיך ולהצליח להגיע בקלות ובנוחות לקהלים חדשים. כעת אנו מתמקדים בתוכן על פרשיות השבוע ומועדי השנה, אך בעתיד אנו מקווים להתרחב לתחומי תוכן נוספים, ליצור פורום דיונים ועוד. השימוש באתר הוא ללא תשלום, מותר להעתיק ולשתף תוכן.
          </p>
        </div>
